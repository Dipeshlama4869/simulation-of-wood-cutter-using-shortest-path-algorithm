...
public class AStar
{
    ...
    public List<NewConnection> PathfindAStar(Graph aGraph, GameObject start, GameObject end,
        ...
        while (OpenList.GetSize() > 0)
        {
            ...
            foreach (NewConnection aConnection in Connections)
            {
                ...
                else
                {
                    ...
                    // We’ll need to calculate the heuristic value using the function, since we don’t havean existing record to use.
              ...
              // We’ve finished looking at the connections for the current node, so add it to the closedlist
...
OpenList.RemoveNodeRecord(CurrentRecord);
        ...
        List<NewConnection> tempList = new List<NewConnection>();
        if (!CurrentRecord.Node.Equals(end))
        {
        ...
        else
        {
            ...
            List<NewConnection> tempList2 = new List<NewConnection>();
